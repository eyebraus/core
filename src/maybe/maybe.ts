 ...
 */
export type Maybe<TValue extends Defined> = Nothing | Something<TValue>;
...
/**
 * Gets all the {@link Maybe}s in a given array that were {@link Something}s.
 * @param maybes An array of {@link Maybe}s.
 * @returns An array of {@link Something}s in the given array.
 */
...
export const unwrap = <TValue extends Defined>(maybe: Maybe<TValue>): TValue => {
    ...
    throw new Error('Expected maybe to be something, but was nothing.');
};
