...
export const Pair = <TFirst extends Defined, TSecond extends Defined>(
    firstValue: TFirst,
    secondValue: TSecond,
): Pair<TFirst, TSecond> => [firstValue, secondValue];
 ...
 * @returns A new {@link Pair} with the mapped first value and unchanged second value.
 */
export const repositionFirst = <TFirstX extends Defined, TFirstY extends Defined, TSecond extends Defined>(
    pair: Pair<TFirstX, TSecond>,
    fn: (first: TFirstX, second: TSecond) => TFirstY,
): Pair<TFirstY, TSecond> => Pair(fn(first(pair), second(pair)), second(pair));
 ...
 */
export const repositionSecond = <TFirst extends Defined, TSecondX extends Defined, TSecondY extends Defined>(
    pair: Pair<TFirst, TSecondX>,
    fn: (second: TSecondX, first: TFirst) => TSecondY,
): Pair<TFirst, TSecondY> => Pair(first(pair), fn(second(pair), first(pair)));
